        ...
        <link rel="canonical" href="https://pro-handwerker.de/impressum" />
            ...
            <header className="hero-img">
                ...
                <div className="container-fluid mt-5 pt-5">
                    <div className="container">
                        <h1 className="text-center display-3 fw-bold text-white">Impressum</h1>
                    </div>
                </div>
            </header>
            ...
            <div className="container pt-5">
                ...
                <div className="col-12 col-md-10 col-lg-8">
                    ...
                    <p className="fs-5">
                        Die Europäische Kommission stellt eine Plattform zur Online-Streitbeilegung (OS) bereit:<br /> <a href="https://ec.europa.eu/consumers/odr" target={"_blank"}>https://ec.europa.eu/consumers/odr.</a>
                        <br />Unsere E-Mail-Adresse finden Sie oben im Impressum.
                    </p>
                    <h1 className="fs-2 fw-bold mb-2">Verbraucher­streit­beilegung Universal­schlichtungs­stelle</h1>
                    <p className="fs-5">
                        Wir sind nicht bereit oder verpflichtet, an Streitbeilegungsverfahren vor einer Verbraucherschlichtungsstelle teilzunehmen.
                    </p>
                    <h1 className="fs-2 fw-bold mb-2">Haftung für Inhalte</h1>
                    <p className="fs-5">
                    ...
                    <h1 className="fs-2 fw-bold mb-2">Haftung für Links</h1>
                    <p className="fs-5">
                    ...
                    <h1 className="fs-2 fw-bold mb-2">Urheberrecht</h1>
