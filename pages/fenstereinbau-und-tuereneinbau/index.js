...
const Region = () => {
    return (
        <>
            <Head>
                <title>Türeneinbau und Fenstereinbau -
            ...
            <header className="hero-img">
                ...
                <div className="container-fluid mt-5 pt-5">
                    <div className="container">
                        <h1 className="text-center display-3 fw-bold text-white">Türeneinbau und Fenstereinbau -
                            Stadt wählen</h1>
                        <h2 className="text-center fs-6 text-white mb-3">Türeneinbau und Fenstereinbau Experte -
            ...
            <div className="container">
                <h1 className="fs-2 py-4 mt-3 fw-bold">Finden Sie Ihren Türeneinbau und Fenstereinbau Service in Ihrer Stadt</h1>
                <div id="alphaLink" className="d-flex bg-secondary text-white px-2 mb-4 align-items-center flex-wrap">
                    {
                        alpha.map(letter => {
                            return (
                                <>
                                    <Link className="alpha-pagination" href={`/fenstereinbau-und-tuereneinbau#starWith_${letter}`}>{letter}</Link>

                                </>
                            )
                        })
                    }
                    <Link className="alpha-pagination" href={`/fenstereinbau-und-tuereneinbau#starWith_idn`}>IDN</Link>
                </div>
                {
                    alpha.map((letter) => {
                        return (
                            <>
                                <div id={`starWith_${letter}`}>
                                    <div className="border-top border-bottom bg-light d-flex justify-content-between align-items-center">
                                        ...
                                        <div className="px-3"><Link className="text-decoration-underline hov-cl-yellow" href={`/fenstereinbau-und-tuereneinbau#alphaLink`}>Back to list</Link></div>
                                    </div>
