...
export default function FgartenUndLandschaftsbauer() {
  return (
    <>
      <Head>
        <title>Terrassenbauer - Pflasterarbeiten in Wuppertal - Pro Handwerker</title>
      ...
      <header className="hero-img">
        ...
        <div className="container-fluid mt-5 pt-5">
          <div className="container">
            <h1 className="text-center display-3 fw-bold text-white">Terrassenbauer - Pflasterarbeiten in Wuppertal</h1>
      ...
      <main>
        <div className="container pt-5">
          <h1 className="display-5 fw-bold mb-4">Garten und Landschaftsbauer in Wuppertal<br/><span className="fs-2">innovative Gartengestaltung</span></h1>
          <div className="col-12 col-md-10 col-lg-8">
            <p className="fs-5">Terrassenbau - Terrassensanierung - Pflasterarbeiten - Garten und Landschaftsbauer in Wuppertal</p>
            ...
            {/* Another Section START */}
              <div className="row">
                <div className="col-4">
                <img className="img-fluid rounded shadow-sm" src="img/garten-und-landschaftsbauer/terassenbauer-pflasterarbeiten.jpg" alt="garten-und-landschaftsbauer" />
                </div>
                ...
                <div className="col-6">
                  <ul className="uber-ul">
                    ...
                    <li className="fs-5">Terrassenbau in Wuppertal</li>
            ...
            {/* Another Section START */}
            <h1 className="display-5 fw-bold my-4">Aufbau einer Terrasse: Die wichtigsten Fragen</h1>
            ...
            {/* Another Section START */}
            <h1 className="display-5 fw-bold my-4">Terrassenbau - Terrassensanierung - Pflasterarbeiten in Wuppertal</h1>
            <ul className="uber-ul">
              <li className="fs-5 mb-2">Neu- und Umgestaltung</li>
              <li className="fs-5 mb-2">Terrassenbau,</li>
              <li className="fs-5 mb-2">Terrassensanierung ,</li>
              <li className="fs-5 mb-2">Pflasterarbeiten ( Gärtnerische Landschaftsarbeiten ) ,</li>
              <li className="fs-5 mb-2">Zaunbau ,</li>
              <li className="fs-5 mb-2">Einbau von Balkontüren,</li>
              <li className="fs-5 mb-2">USW.</li>
            </ul>

            <h1 className="display-5 fw-bold my-4">Terrassenbau - Terrassensanierung - Pflasterarbeiten kosten</h1>
            ...
            <h1 className="display-5 fw-bold my-4">Materialunterkonstruktion:</h1>
            ...
            <h1 className="display-5 fw-bold my-4">So implementieren Sie Ihre Terrassenkonstruktion</h1>
