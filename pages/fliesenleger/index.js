...
const Region = () => {
    return (
        <>
            <Head>
                <title>Fliesenleger - Stadt wählen ❤️ Pro Handwerker</title>
            ...
            <header className="hero-img">
                ...
                <div className="container-fluid mt-5 pt-5">
                    <div className="container">
                        <h1 className="title-text display-3">Fliesenleger -
                            Stadt wählen</h1>
                        <h2 className="txt2">Fliesenleger Experte -
            ...
            <div className="container">
                <h3 className="fs-2 py-4 mt-3 fw-bold">Finden Sie Ihren Fliesenleger Service in Ihrer Stadt</h3>
